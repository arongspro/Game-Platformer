  ...
  _mapData(mapId) {
    ...
    const maps = {
      ...
      duel: {
        ...
        boxes: [
          // ── 바닥 ──
          [0,-0.5,0, 44,0.5,44, 0x0d0d1a,'checker'],

          // ── 외곽 벽 4면 ──
          [0, 3, 22,  44,6,0.5, 0x111133,'solid'],
          [0, 3,-22,  44,6,0.5, 0x111133,'solid'],
          [22, 3, 0,  0.5,6,44, 0x111133,'solid'],
          [-22, 3, 0, 0.5,6,44, 0x111133,'solid'],

          // ── 스폰 A (Z+16) : 보급 상자 플랫폼 ──
          [0, 0.5, 16,  6,1,4,  0x223355,'solid'],   // 스폰 플랫폼
          [-3,1.5,16,   1,1,1,  0x00aaff,'solid'],   // 보급 상자 L
          [3, 1.5,16,   1,1,1,  0x00aaff,'solid'],   // 보급 상자 R
          // 스폰 A 좌우 엄폐물
          [-5, 1, 16,  1,2,3,  0x1a2244,'solid'],
          [5,  1, 16,  1,2,3,  0x1a2244,'solid'],
          ...
          // ── 중앙 코어 (점대칭) ──
          [0, 1, 0,  4,2,4,  0x7700cc,'noise'],       // 중앙 기둥
          [0, 3, 0,  6,0.5,6,  0xaa44ff,'solid'],     // 코어 상단 플랫폼

          // ── 중앙 좌우 대형 엄폐물 (점대칭) ──
          [-10, 1, 0,  2,2,7,  0x1a2255,'solid'],
          [10,  1, 0,  2,2,7,  0x1a2255,'solid'],

          // ── 중간 지역 플랫폼 (점대칭 4개) ──
          [-7, 2, 8,  4,0.5,3,  0x223366,'solid'],
          [7,  2,-8,  4,0.5,3,  0x223366,'solid'],
          [7,  2, 8,  4,0.5,3,  0x223366,'solid'],
          [-7, 2,-8,  4,0.5,3,  0x223366,'solid'],

          // ── 중간 지역 세로 엄폐물 (점대칭) ──
          [-14, 1, 5,  1,2,5,  0x112244,'solid'],
          [14,  1,-5,  1,2,5,  0x112244,'solid'],
          [14,  1, 5,  1,2,5,  0x112244,'solid'],
          [-14, 1,-5,  1,2,5,  0x112244,'solid'],

          // ── 코너 고지대 (점대칭) ──
          [-16, 2, 16,  3,0.5,3,  0x1a2233,'solid'],
          [16,  2,-16,  3,0.5,3,  0x1a2233,'solid'],
          [16,  2, 16,  3,0.5,3,  0x1a2233,'solid'],
          [-16, 2,-16,  3,0.5,3,  0x1a2233,'solid'],
          [-16, 4, 16,  2,0.5,2,  0x223344,'solid'],
          [16,  4,-16,  2,0.5,2,  0x223344,'solid'],
          [16,  4, 16,  2,0.5,2,  0x223344,'solid'],
          [-16, 4,-16,  2,0.5,2,  0x223344,'solid'],

          // ── 사이드 통로 레일 (점대칭) ──
          [-19, 3, 0,  2,0.5,10,  0x111122,'solid'],
          [19,  3, 0,  2,0.5,10,  0x111122,'solid'],
        ],
      },
    };
