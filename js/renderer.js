    ...
    const maps = {
      ...
      duel: {
        ...
        boxes: [
          ...
          // 바닥 (80x80 대형 아레나)
          // ══════════════════════════════════════
          [0,-0.5,0, 80,0.5,80, 0x0a0a18,'checker'],

          // ══════════════════════════════════════
          // 외곽 벽 (높이 8, 두께 1)
          // ══════════════════════════════════════
          [0, 4, 40,  80,8,1, 0x0e0e22,'solid'],   // 북벽
          [0, 4,-40,  80,8,1, 0x0e0e22,'solid'],   // 남벽
          [40, 4, 0,  1,8,80, 0x0e0e22,'solid'],   // 동벽
          [-40,4, 0,  1,8,80, 0x0e0e22,'solid'],   // 서벽

          // ══════════════════════════════════════
          // 스폰 A — Z+30 (바닥에 스폰, 머리 안끼게 천장 없음)
          // ══════════════════════════════════════
          // 스폰 바닥 플랫폼 (두께 1, 위면 y=0)
          [0,-0.5,30, 14,1,8, 0x1a2a4a,'solid'],
          // 앞 엄폐 낮은 벽 (플레이어가 숨을 수 있는 높이 2)
          [0, 1, 26,  10,2,1, 0x223355,'solid'],
          // 보급 상자 2개 (스폰 플랫폼 위, 양쪽에)
          [-4, 1, 31,  1.5,2,1.5, 0x0066ff,'solid'],
          [ 4, 1, 31,  1.5,2,1.5, 0x0066ff,'solid'],
          // 좌우 측면 엄폐물
          [-6, 1, 30,  1,2,4, 0x1a2244,'solid'],
          [ 6, 1, 30,  1,2,4, 0x1a2244,'solid'],
          ...
          // 중앙 코어 구조물
          // ══════════════════════════════════════
          [0, 2, 0,   6,4,6,  0x6600bb,'noise'],    // 중앙 기둥 (높이 4)
          [0, 4.5, 0, 9,0.5,9, 0x9933ee,'solid'],   // 기둥 위 플랫폼
          [0, 7, 0,   4,0.5,4, 0xcc55ff,'solid'],   // 최상단 플랫폼

          // ══════════════════════════════════════
          // 중앙 좌우 대형 엄폐벽 (점대칭)
          // ══════════════════════════════════════
          [-14, 1.5, 0,  2,3,10, 0x112244,'solid'],
          [ 14, 1.5, 0,  2,3,10, 0x112244,'solid'],

          // ══════════════════════════════════════
          // 중간 지역 — 앞쪽 구역 (점대칭 4개)
          // ══════════════════════════════════════
          [-10, 2, 16,  5,0.5,4, 0x1a3355,'solid'],  // A쪽 좌 플랫폼
          [ 10, 2,-16,  5,0.5,4, 0x1a3355,'solid'],  // B쪽 우 플랫폼
          [ 10, 2, 16,  5,0.5,4, 0x1a3355,'solid'],  // A쪽 우 플랫폼
          [-10, 2,-16,  5,0.5,4, 0x1a3355,'solid'],  // B쪽 좌 플랫폼

          // 중간 플랫폼 아래 엄폐물
          [-10, 1, 16,  1,2,4, 0x112233,'solid'],
          [ 10, 1,-16,  1,2,4, 0x112233,'solid'],
          [ 10, 1, 16,  1,2,4, 0x112233,'solid'],
          [-10, 1,-16,  1,2,4, 0x112233,'solid'],
          ...
          // 코너 고지대 점프 발판 (점대칭)
          // ══════════════════════════════════════
          [-28, 2, 28,  5,0.5,5, 0x112233,'solid'],
          [ 28, 2,-28,  5,0.5,5, 0x112233,'solid'],
          [ 28, 2, 28,  5,0.5,5, 0x112233,'solid'],
          [-28, 2,-28,  5,0.5,5, 0x112233,'solid'],
          [-28, 4, 28,  3,0.5,3, 0x1a2a44,'solid'],
          [ 28, 4,-28,  3,0.5,3, 0x1a2a44,'solid'],
          [ 28, 4, 28,  3,0.5,3, 0x1a2a44,'solid'],
          [-28, 4,-28,  3,0.5,3, 0x1a2a44,'solid'],
          ...
          // 사이드 하이그라운드 레일 (점대칭)
          // ══════════════════════════════════════
          [-32, 4, 0,  3,0.5,16, 0x0d1122,'solid'],
          [ 32, 4, 0,  3,0.5,16, 0x0d1122,'solid'],
        ],
      },
    };
